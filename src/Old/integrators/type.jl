mutable struct HistorySDEIntegrator{algType,IIP,uType,tType,tdirType,SolType,CacheType} <: AbstractSDEIntegrator{algType,IIP,uType,tType}
  sol::SolType
  u::uType
  t::tType
  dt::tType
...
mutable struct
  ...
  q11::tTypeNoUnits
  history::H
  # integrator::IType # TODO integrator from DDEIntegrator
end
